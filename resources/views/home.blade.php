...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <h1>
            ...
            <select id="version-carbon" onchange="evaluateCode(event)">
                <option value="2.x-dev">2.x-dev</option><option value="3.x-dev">3.x-dev</option><option value="2.46.0">2.46.0</option><option value="2.45.1">2.45.1</option><option value="2.44.0">2.44.0</option><option value="2.43.0">2.43.0</option><option value="2.42.0">2.42.0</option><option value="2.41.5">2.41.5</option><option value="2.40.1">2.40.1</option><option value="2.39.2">2.39.2</option><option value="2.38.0">2.38.0</option><option value="2.37.0">2.37.0</option><option value="2.36.1">2.36.1</option><option value="2.35.0">2.35.0</option><option value="2.34.2">2.34.2</option><option value="2.33.0">2.33.0</option><option value="2.32.2">2.32.2</option><option value="2.31.0">2.31.0</option><option value="2.30.0">2.30.0</option><option value="2.0.0">2.0.0</option><option value="1.39.1">1.39.1</option><option value="1.26.6">1.26.6</option><option value="1.26.3">1.26.3</option>        </select>
        </h1>
    ...
    <div id="input">$mutable = Carbon::now();
    ...
    <script>
        ...
        var input = editor('input', 'ace/mode/php');
        ...
        function setInputWidth(inputWidth, outputWidth) {
            ...
            document.getElementById('h-resize').style.left = (20 + inputWidth) + 'px';
            document.getElementById('options').style.right = (26 + outputWidth + 14) + 'px';
